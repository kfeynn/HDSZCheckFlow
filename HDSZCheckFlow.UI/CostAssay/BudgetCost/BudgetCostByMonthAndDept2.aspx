		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:label id="Label1" style="Z-INDEX: 104; POSITION: absolute; TOP: 24px; LEFT: 32px" runat="server">部门预实分析</asp:label><asp:datagrid id="DataGrid1" style="Z-INDEX: 107; POSITION: absolute; TOP: 104px; LEFT: 32px"
				...
				<Columns>
					...
					<asp:BoundColumn DataField="budgetMoney" HeaderText="预算金额" DataFormatString="{0:N2}">
					...
					<asp:BoundColumn DataField="planmoney" HeaderText="推算金额" DataFormatString="{0:N2}">
						<HeaderStyle HorizontalAlign="Right"></HeaderStyle>
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundColumn>
					...
					<asp:BoundColumn DataField="costPY" HeaderText="比率">
						<HeaderStyle HorizontalAlign="Right"></HeaderStyle>
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundColumn>
				</Columns>
			...
			<TABLE id="Table1" style="Z-INDEX: 106; POSITION: absolute; WIDTH: 848px; HEIGHT: 40px; TOP: 48px; LEFT: 32px"
				...
				<TR>
					...
					<TD><asp:textbox id="txtDate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy年MM月'})" runat="server"></asp:textbox></TD>
					...
					<TD><asp:label id="lblMessage" runat="server" Width="113px"></asp:label>
						<asp:Button id="Button1" runat="server" Width="84px" CssClass="inputbutton" Text="导出" Visible="False"></asp:Button></TD>
				</TR>
			</TABLE>
		</form>
	</body>
