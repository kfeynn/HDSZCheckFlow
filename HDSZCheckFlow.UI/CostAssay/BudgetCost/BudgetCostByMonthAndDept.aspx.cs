...
namespace HDSZCheckFlow.UI.CostAssay.BudgetCost
{
	...
	/// </summary>
	public class BudgetCostByMonthAndDept : System.Web.UI.Page
	{
		...
		private void btnQuery_Click(object sender, System.EventArgs e)
		{
			...
			//DataSet ds=Bussiness.CostBLL.GetBudgetCostByDept(dt.Year,dt.Month,runReport.BudgetDept,runReport.FirstClassAccount);
