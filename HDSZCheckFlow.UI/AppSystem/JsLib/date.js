...
var _VersionInfo="Version:2003 作者:iOffice.net"	//版本信息
...
strFrame='<style>';
strFrame+='INPUT.button{BORDER-RIGHT: #0066cc 1px solid;BORDER-TOP: #0066cc 1px solid;BORDER-LEFT: #0066cc 1px solid;';
strFrame+='BORDER-BOTTOM: #0066cc 1px solid;BACKGROUND-COLOR: #fff8ec;font-family:宋体;}';
strFrame+='INPUT.button2{BORDER-RIGHT: #0066cc 1px solid;BORDER-TOP: #0066cc 1px solid;BORDER-LEFT: #0066cc 1px solid;';
strFrame+='BORDER-BOTTOM: #0066cc 1px solid;BACKGROUND-COLOR: #d0e8ff;font-family:宋体;}';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#0066cc bgcolor=#0066cc Author="wayx">';
...
strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=#0066cc style="font-size:12px;cursor: hand;color: #ffffff" ';
strFrame+='        onclick="parent.meizzPrevM()" title="向前翻 1 月" Author=meizz><b Author=meizz>&lt;</b>';
strFrame+='        </td><td width=60 align=center style="font-size:12px;cursor:default" Author=meizz ';
strFrame+='onmouseover="style.backgroundColor=\'#0066cc\'" onmouseout="style.backgroundColor=\'white\'" ';
...
strFrame+='<td width=48 align=center style="font-size:12px;cursor:default" Author=meizz onmouseover="style.backgroundColor=\'#0066cc\'" ';
strFrame+=' onmouseout="style.backgroundColor=\'white\'" onclick="parent.tmpSelectMonthInnerHTML(this.innerText.length==3?this.innerText.substring(0,1):this.innerText.substring(0,2))"';
strFrame+='        title="点击这里选择月份"><span id=meizzMonthHead Author=meizz></span></td>';
strFrame+='        <td width=16 bgcolor=#0066cc align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 bgcolor=#0066cc ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
strFrame+=' BORDERCOLORLIGHT=#0066cc BORDERCOLORDARK=#FFFFFF width=140 height=20 Author="wayx" style="cursor:' + (bMoveable ? 'move':'default') + '">';
...
strFrame+='    <table border=1 cellspacing=2 cellpadding=0 BORDERCOLORLIGHT=#0066cc BORDERCOLORDARK=#FFFFFF bgcolor=#fff8ec width=140 height=120 Author="wayx">';
...
strFrame+='          <tr Author="wayx"><td Author=meizz align=left><input Author=meizz type=button class=button2 value="<<" title="向前翻 1 年" onclick="parent.meizzPrevY()" ';
strFrame+='             onfocus="this.blur()" style="font-size: 12px; height: 20px"><input Author=meizz class=button2 title="向前翻 1 月" type=button ';
strFrame+='             value="< " onclick="parent.meizzPrevM()" onfocus="this.blur()" style="font-size: 12px; height: 20px"></td><td ';
strFrame+='             Author=meizz align=center><input Author=meizz type=button class=button2 value=今天 onclick="parent.meizzToday()" ';
strFrame+='             onfocus="this.blur()" title="当前日期" style="font-size: 12px; height: 20px; cursor:hand"></td><td ';
strFrame+='             Author=meizz align=right><input Author=meizz type=button class=button2 value=" >" onclick="parent.meizzNextM()" ';
strFrame+='             onfocus="this.blur()" title="向后翻 1 月" class=button2 style="font-size: 12px; height: 20px"><input ';
strFrame+='             Author=meizz type=button class=button2 value=">>" title="向后翻 1 年" onclick="parent.meizzNextY()"';
...
function setday(tt,obj) //主调函数
{
	...
	//if (tt.style.disabled == "disabled" || tt.style.readonly == "readonly"){return;} //如果控件只读，则退出。罗显华加2006.8.7
	var th = tt;
      ...
      { 
		...
		if(i<firstday)		//上个月的部分
		{
			...
			else
			{
				...
				meizzWDay[i] == new Date().getDate()) ? "#0066cc":"#e0e0e0");
				//将选中的日期显示为凹下去
				if((mm==1?yy-1:yy)==outDate.getFullYear() && (mm==1?12:mm-1)== outDate.getMonth() + 1 && 
				meizzWDay[i]==outDate.getDate())
				{
					da.borderColorLight="#FFFFFF";
					da.borderColorDark="#0066cc";
				}
			}
		}
