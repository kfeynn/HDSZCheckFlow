...
function window.onload()
{
	...
	g_winDocAll['id' + g_arrayMenuBar[0]].style.height = "100%";
	g_winDocAll['id' + g_arrayMenuBar[0]].style.display="";
...
{
    g_divHeight = document.body.clientHeight - 25 * g_lTotalMenuBars;
	   for( i = 0; i < g_lTotalMenuBars; i++)
	   {
	       g_winDocAll['div' + g_arrayMenuBar[i]].style.height = g_divHeight;
	   }
}
