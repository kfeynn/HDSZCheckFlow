...
namespace HDSZCheckFlow.UI.CheckFlow.CheckFlow
{
	...
	/// </summary>
	public class AuditingForOneApply_F : System.Web.UI.Page
	{
...
//						}
		...
		{
			//回到我的审批页面
			Response.Redirect("MyAuditing_F.aspx");
		}
		...
		private void btnPass_Click(object sender, System.EventArgs e)
		{
			...
			if(IsAuditinged() == 1 )
			{
				...
				Audi.Flow_AgreeApplySheet(2,myCode,int.Parse(ApplySheetHeadPk),disPlaysCode,this.txtPosital.Text,1 );
