<%@ Page language="c#" Codebehind="ApplySheetEditNew.aspx.cs" AutoEventWireup="false" Inherits="HDSZCheckFlow.UI.CheckFlow.CheckFlow.ApplySheetEditNew"  EnableEventValidation="false" %>
...
<HTML>
	<HEAD>
		...
		<script language="javascript" src="../../AppSystem/JsLib/jquery-1.6.min.js"></script>
		<script language="javascript" src="../../AppSystem/JsLib/myHandleRequest.js"></script>
		<script language="javascript"> 
		window.XPGrid="XPGrid2";
		...
		<form id="Form1" method="post" runat="server">
			<FONT face="宋体">
				<TABLE id="Table1" style="Z-INDEX: 101; POSITION: absolute; TOP: 40px; LEFT: 20px" cellSpacing="1"
					...
					<TR>
						<TD>
							<TABLE id="Table3" cellSpacing="0" cellPadding="1" width="100%" align="left" border="0">
								<TR>
									<TD colspan="2" width="90%" align="center"><asp:button id="btnInConrt" 
                                            runat="server" Text="预算内提交" Enabled="False" CssClass="ButtonFlat"></asp:button><asp:button id="btnOutConrt" 
                                            runat="server" Text="预算外提交" Enabled="False" CssClass="ButtonFlat"></asp:button></TD>
									<TD>
										<asp:button style="Z-INDEX: 0" id="btnUpdate" runat="server" 
                                            CssClass="ButtonFlat" Text="更新金额信息"  ></asp:button></TD>
								</TR>
							</TABLE>
					...
					<TR>
						<TD><gridwc:xpgrid id="XPGrid1" runat="server" PageSize="10" width="100%" 
                                AllowAdd="False" AllowDelete="True"
								AllowEdit="True" AllowExportExcel="True" AllowPrint="True" AllowSort="True" 
                                SelectKind="SingleLine"></gridwc:xpgrid></TD>
					</TR>
					<tr height="28">
						<td>
					...
					<TR>
						<TD><gridwc:xpgrid id="XPGrid2" runat="server" width="100%" AllowAdd="True" 
			...
			<%--<script language=javascript type='text/javascript' src='../../xpGrid/Query/QueryControl/scripts/xmlExecute.js' ></script>--%>
<%--			<script language=javascript >
			function DataCommunicate(strXML,ActionFileURL) {

			    alert(strXML + ' : aa  :' + ActionFileURL);
