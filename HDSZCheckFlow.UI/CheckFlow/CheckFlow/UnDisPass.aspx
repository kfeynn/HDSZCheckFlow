...
<%@ Page language="c#" Codebehind="UnDisPass.aspx.cs" AutoEventWireup="false" Inherits="HDSZCheckFlow.UI.CheckFlow.CheckFlow.UnDisPass"  EnableEventValidation="false"  %>
					...
					<td align="center" colspan="6"><FONT face="宋体">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD align="center" style="HEIGHT: 17px">单据号</TD>
									<TD style="HEIGHT: 17px">
				...
				<tr id="bodyInfo" style="DISPLAY: block; HEIGHT: 22px">
					<td style="BACKGROUND-COLOR: #e8f4ff; WIDTH: 100%" align="center" colSpan="6"><asp:datagrid id="dgApply" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#93BEE2"
							...
							<Columns>
								...
								<asp:BoundColumn Visible="False" DataField="ApplySheetNo" HeaderText="单据号"></asp:BoundColumn>
