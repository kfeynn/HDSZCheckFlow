<%@ Page language="c#" Codebehind="OrderList.aspx.cs" AutoEventWireup="false" Inherits="HDSZCheckFlow.UI.BaseData.BudGet.OrderList" enableEventValidation="false" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table class="GbText" id="tabDispDocument" style="Z-INDEX: 101; POSITION: absolute; BORDER-BOTTOM-COLOR: #0066cc; BORDER-TOP-COLOR: #0066cc; WIDTH: 100%; BORDER-COLLAPSE: collapse; HEIGHT: 36px; BORDER-RIGHT-COLOR: #0066cc; BORDER-LEFT-COLOR: #0066cc; TOP: 0px; LEFT: 0px"
				...
				<tr style="HEIGHT: 28px">
					<td align="center" colSpan="6"><FONT face="宋体">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									<TD style="WIDTH: 93px">订&nbsp;&nbsp; 单 &nbsp;号</TD>
									<TD style="WIDTH: 506px">
										<asp:textbox id="txtOrderNumber" runat="server" Width="160px"></asp:textbox></TD>
									<TD></TD>
									<TD><asp:button id="btnQuery" runat="server" Width="72px" Text="查询" CssClass="redButtonCss"></asp:button>
										<asp:Button style="Z-INDEX: 0" id="btnOutput" runat="server" Text="导出到Excel" CssClass="redButtonCss"></asp:Button></TD>
									<TD align="center"></TD>
								</TR>
							</TABLE>
						</FONT>
				...
				<tr style="HEIGHT: 28px">
					<td style="WIDTH: 100%; HEIGHT: 27px" align="right" background="../../Style/Images/treetopbg.jpg"
						colSpan="6"><FONT face="宋体"></FONT><FONT face="宋体"></FONT><FONT face="宋体">
							<asp:CheckBox id="chbSelectAll" runat="server" Text="全选" AutoPostBack="True"></asp:CheckBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<td style="BACKGROUND-COLOR: #e8f4ff; WIDTH: 20%" align="center" colSpan="6"><FONT face="宋体">
							<asp:Panel id="Panel1" runat="server" BackColor="White" Visible="False">
								<TABLE id="Table2" border="1" cellSpacing="0" borderColor="#003333" cellPadding="0" width="100%">
									<TR>
										<TD style="WIDTH: 101px; HEIGHT: 22px">单 据 号：</TD>
