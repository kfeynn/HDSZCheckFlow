					...
					<td align="center" colSpan="6"><FONT face="宋体">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD></TD>
									<TD>
										<asp:Button id="btnOutput" runat="server" Text="导出到Excel" CssClass="inputbutton" Visible="False"></asp:Button></TD>
								</TR>
							</TABLE>
						</FONT>
					</td>
