<%@ Page language="c#" Codebehind="CancelOrderPurchase.aspx.cs" AutoEventWireup="false" Inherits="HDSZCheckFlow.UI.OrderManage.BaseInfo.CancelOrderPurchase"  EnableEventValidation="false" %>
			...
			<table class="GbText" id="tabDispDocument" style="Z-INDEX: 101; BORDER-LEFT-COLOR: #0066cc; LEFT: 0px; BORDER-BOTTOM-COLOR: #0066cc; WIDTH: 100%; BORDER-TOP-COLOR: #0066cc; POSITION: absolute; TOP: 0px; BORDER-COLLAPSE: collapse; HEIGHT: 36px; BORDER-RIGHT-COLOR: #0066cc"
				...
				<TBODY>
					<tr style="HEIGHT: 28px">
						<td align="center" colSpan="6"><FONT face="宋体">
								<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
									<tr>
										<td style="WIDTH: 93px" height="26">定&nbsp;&nbsp; 单&nbsp;&nbsp;号</td>
										<td style="WIDTH: 328px">
											<asp:TextBox id="txtOrderNo" runat="server"></asp:TextBox></td>
									</tr>
									<TR>
										<TD style="WIDTH: 93px; HEIGHT: 17px">单&nbsp;&nbsp; 据&nbsp;&nbsp;号</TD>
										<TD style="WIDTH: 328px; HEIGHT: 17px"><asp:textbox id="txtApplyNo" runat="server" Width="232px"></asp:textbox>(以逗号分隔)</TD>
										<TD style="HEIGHT: 17px">
											申请部门</TD>
										<TD style="HEIGHT: 17px"><asp:dropdownlist id="ddlDeptClass" runat="server" Width="166px" AutoPostBack="True"></asp:dropdownlist><asp:dropdownlist id="ddlDept" runat="server" Width="166px"></asp:dropdownlist></TD>
										<TD style="HEIGHT: 17px" align="center"></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 93px">产 品 编 号</TD>
										<TD style="WIDTH: 328px"><asp:textbox id="txtProduct" runat="server" Width="232px"></asp:textbox>(以逗号分隔)</TD>
										<TD>
											存货分类</TD>
										<TD>
									...
									<TR>
										...
										<TD style="WIDTH: 328px; HEIGHT: 24px"><asp:textbox id="txtDateFrom" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'txtDateTo\')||\'2020-10-01\'}'})" runat="server" Width="128px"></asp:textbox>至
											<asp:textbox id="txtDateTo" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'txtDateFrom\')}',maxDate:'2020-10-01'})" runat="server" Width="136px"></asp:textbox></TD>
										<TD style="HEIGHT: 24px"></TD>
										<TD style="HEIGHT: 24px"><asp:button id="btnQuery" runat="server" Width="72px" CssClass="redButtonCss" Text="查询"></asp:button></TD>
					...
					<tr id="bodyInfo" style="HEIGHT: 22px">
						<td style="WIDTH: 100%; HEIGHT: 161px; BACKGROUND-COLOR: #e8f4ff" align="center" colSpan="6"><asp:datagrid id="dgApply" runat="server" Width="100%" AllowSorting="True" PageSize="20" BorderColor="#93BEE2"
					...
					<tr style="HEIGHT: 26px">
						<td style="WIDTH: 10%; HEIGHT: 28px" align="left" background="../../Style/Images/treetopbg.jpg"
							colSpan="1"><FONT face="宋体"><asp:checkbox id="chbSelectAll" runat="server" AutoPostBack="True" Text="全选"></asp:checkbox></FONT></td>
						<td style="WIDTH: 40%; HEIGHT: 28px" align="center" background="../../Style/Images/treetopbg.jpg"
							colSpan="2"><FONT face="宋体"><asp:imagebutton id="imgBtnUp" runat="server" Width="25px" ImageUrl="../../Style/Images/up.jpg" Height="26px"></asp:imagebutton></FONT></td>
						<td style="WIDTH: 50%; HEIGHT: 28px" align="center" background="../../Style/Images/treetopbg.jpg"
							colSpan="3"><asp:imagebutton id="imgBtnDown" runat="server" Width="24px" ImageUrl="../../Style/Images/down.jpg"
								Height="24px"></asp:imagebutton><asp:label id="lblMessage" runat="server"></asp:label></td>
					</tr>
					<tr id="postail" style="DISPLAY: block; HEIGHT: 28px">
						<td style="WIDTH: 20%; BACKGROUND-COLOR: #e8f4ff" align="center" colSpan="6"><asp:panel id="Panel1" runat="server" BackColor="White" Visible="true">
								<asp:datagrid id="dgOrder" runat="server" Width="100%" AutoGenerateColumns="False" BackColor="White"
					...
					<tr style="HEIGHT: 28px">
						<td style="WIDTH: 100%" align="center" background="../../Style/Images/treetopbg.jpg"
							colSpan="6"><FONT face="宋体"><asp:button id="btnSaveOrder" runat="server" Text="确定" Width="89px"></asp:button></FONT></td>
					</tr>
				</TBODY>
			</table>
			<INPUT id="IsEdit" style="Z-INDEX: 104; LEFT: 624px; POSITION: absolute; TOP: 528px" type="hidden"
				value="0" name="Hidden1" runat="server"> <INPUT id="pagesIndex" style="Z-INDEX: 104; LEFT: 624px; POSITION: absolute; TOP: 528px"
