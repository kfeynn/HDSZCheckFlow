<%@ Page language="c#" Codebehind="AssetPaymentRemarks.aspx.cs" AutoEventWireup="false" Inherits="HDSZCheckFlow.UI.Asset.FixedAssets2.AssetPaymentRemarks" EnableEventValidation="false" %>
				...
				<tr style="HEIGHT: 28px">
					<td align="center" colSpan="6"><FONT face="宋体">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<tr>
									<td style="WIDTH: 93px" height="26"><STRONG>付款</STRONG></td>
								</tr>
								<TR>
				...
				<tr id="bodyInfo" style="DISPLAY: block; HEIGHT: 22px">
					<td style="BACKGROUND-COLOR: #e8f4ff; WIDTH: 100%" align="center" colSpan="6"><asp:datagrid id="dgApply" runat="server" Width="100%" AllowSorting="True" PageSize="20" BorderColor="#93BEE2"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="IsPayFor" HeaderText="付款"></asp:BoundColumn>
								<asp:BoundColumn DataField="PayForSigner" HeaderText="标注人员"></asp:BoundColumn>
								<asp:BoundColumn DataField="ReallyPayMoney" HeaderText="付款金额"></asp:BoundColumn>
								<asp:BoundColumn DataField="PayForDatetime" HeaderText="付款时间"></asp:BoundColumn>
								<asp:BoundColumn DataField="PayForRemark" HeaderText="付款备注"></asp:BoundColumn>
								<asp:BoundColumn DataField="Earnest" HeaderText="预付款"></asp:BoundColumn>
					...
					<td style="BACKGROUND-COLOR: #e8f4ff; WIDTH: 20%" align="center" colSpan="6"><FONT face="宋体">
							<asp:Panel id="Panel1" runat="server" BackColor="White" Visible="False">
								<TABLE id="Table2" border="1" cellSpacing="0" borderColor="#003333" cellPadding="0" width="100%">
									...
									<TR>
										<TD style="WIDTH: 101px; HEIGHT: 21px">付款时间：</TD>
										<TD style="HEIGHT: 21px">&nbsp;
											<asp:TextBox style="Z-INDEX: 0" id="txtDate" onfocus="WdatePicker()" runat="server" Width="120px"></asp:TextBox></TD>
										<TD style="HEIGHT: 21px"></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 101px">是否付款：</TD>
										<TD>&nbsp;
											<asp:CheckBox id="CheckBox1" runat="server" Text="是/否"></asp:CheckBox></TD>
										<TD></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 101px">付款金额：</TD>
										<TD>&nbsp;
											<asp:TextBox style="Z-INDEX: 0" id="TextBox2" runat="server" Width="120px"></asp:TextBox>(不填写则为申请金额)</TD>
										<TD></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 101px">备&nbsp;&nbsp;&nbsp;&nbsp;注：</TD>
										<TD>&nbsp;
											<asp:TextBox id="TextBox1" runat="server" Width="320px" Height="56px" TextMode="MultiLine"></asp:TextBox></TD>
										<TD></TD>
									</TR>
									<TR>
