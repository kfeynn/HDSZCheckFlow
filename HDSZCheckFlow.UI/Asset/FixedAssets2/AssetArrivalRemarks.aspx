				...
				<tr style="HEIGHT: 28px">
					<td align="center" colSpan="6"><FONT face="宋体">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<tr>
									<td style="WIDTH: 93px" height="26"><STRONG>到货</STRONG></td>
								</tr>
								<TR>
								...
								<TR>
									<TD style="WIDTH: 93px">到 货 日 期</TD>
									<TD style="WIDTH: 506px">
										<asp:textbox style="Z-INDEX: 0" id="txtDateFrom" runat="server" Width="128px" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'txtDateTo\')||\'2020-10-01\'}'})"
											maxdate="#F{$('txtDateTo').value}"></asp:textbox>至
									...
									<TD><asp:button id="btnQuery" runat="server" Width="72px" Text="查询" CssClass="redButtonCss"></asp:button>
										<asp:button style="Z-INDEX: 0" id="Button1" runat="server" Width="72px" Text="导出" CssClass="redButtonCss"></asp:button></TD>
									<TD align="center"></TD>
								</TR>
							</TABLE>
						</FONT>
				...
				<tr id="bodyInfo" style="DISPLAY: block; HEIGHT: 22px">
					<td style="BACKGROUND-COLOR: #e8f4ff; WIDTH: 100%" align="center" colSpan="6"><asp:datagrid id="dgApply" runat="server" Width="100%" AllowSorting="True" PageSize="20" BorderColor="#93BEE2"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="ArriveSigner" HeaderText="标注人员"></asp:BoundColumn>
								<asp:BoundColumn DataField="ArriveDatetime" HeaderText="到货时间"></asp:BoundColumn>
							</Columns>
