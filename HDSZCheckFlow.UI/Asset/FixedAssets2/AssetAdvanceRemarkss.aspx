<%@ Page language="c#" Codebehind="AssetAdvanceRemarkss.aspx.cs" AutoEventWireup="false" Inherits="HDSZCheckFlow.UI.Asset.FixedAssets2.AssetAdvanceRemarkss" EnableEventValidation="false" %>
				...
				<tr style="HEIGHT: 28px">
					<td align="center" colSpan="6"><FONT face="宋体">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<tr>
									<td style="WIDTH: 93px" height="26"><STRONG>预付款</STRONG></td>
								</tr>
								<TR>
				...
				<tr id="bodyInfo" style="DISPLAY: block; HEIGHT: 22px">
					<td style="BACKGROUND-COLOR: #e8f4ff; WIDTH: 100%" align="center" colSpan="6"><asp:datagrid id="dgApply" runat="server" Width="100%" AllowSorting="True" PageSize="20" BorderColor="#93BEE2"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="EarnestSigner" HeaderText="标注人员"></asp:BoundColumn>
								<asp:BoundColumn DataField="EarnestDatetime" HeaderText="预付款时间"></asp:BoundColumn>
								<asp:BoundColumn DataField="EarnestRemark" HeaderText="备注"></asp:BoundColumn>
							</Columns>
