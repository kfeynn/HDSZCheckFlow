<%@ Page language="c#" Codebehind="PrintApply_Asset_PriceCheck.aspx.cs" AutoEventWireup="false" Inherits="HDSZCheckFlow.UI.Asset.PrintApply.PriceCheck.PrintApply_Asset_PriceCheck"  EnableEventValidation="false" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>价格裁决申请打印页面</title>
				...
				<tr style="HEIGHT: 28px">
					<td align="center" colspan="6"><FONT face="宋体">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									<TD height="26" style="WIDTH: 66px"></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 66px; HEIGHT: 17px">申请类型</TD>
									<TD style="WIDTH: 195px; HEIGHT: 17px">
										<asp:DropDownList id="ddlType" runat="server" Width="90px"></asp:DropDownList></TD>
									<TD style="WIDTH: 76px; HEIGHT: 17px">起始日期</TD>
