...
namespace HDSZCheckFlow.UI.Asset.BudgetCost
{
	...
	/// </summary>
	public class Asset_BudgetCostUseDetialInfoAll : System.Web.UI.Page
	{
		...
		private void InitPageForAdd()
		{
			...
			{
				HDSZCheckFlow.Common.Log.Logger.Log("Asset.BudgetCost.Asset_BudgetCostUseDetialInfoAll",ex.Message );
			}
