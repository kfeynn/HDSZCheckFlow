<%@ Page language="c#"  Codebehind="SmallFixedAssetsManualAdd.aspx.cs" AutoEventWireup="false" Inherits="HDSZCheckFlow.UI.Asset.SmallAssets.SmallFixedAssetsManualAdd"  EnableEventValidation="false" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table style="Z-INDEX: 101; POSITION: absolute; BORDER-BOTTOM-COLOR: #0066cc; BORDER-TOP-COLOR: #0066cc; WIDTH: 100%; BORDER-COLLAPSE: collapse; HEIGHT: 36px; BORDER-RIGHT-COLOR: #0066cc; BORDER-LEFT-COLOR: #0066cc; TOP: 0px; LEFT: 0px"
				...
				<TR style="DISPLAY: block; HEIGHT: 22px" id="bodyInfo">
					<TD style="BACKGROUND-COLOR: #e8f4ff; WIDTH: 101.88%" colSpan="10" align="center"><asp:datagrid id="dgApply" runat="server" Width="100%" AutoGenerateColumns="False" BackColor="White"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="iNum" SortExpression="iNum" HeaderText="起始数量"></asp:BoundColumn>
								<asp:BoundColumn DataField="RetireNum" SortExpression="RetireNum" HeaderText="报废数量"></asp:BoundColumn>
								<asp:BoundColumn DataField="LeftNum" SortExpression="LeftNum" HeaderText="剩余数量"></asp:BoundColumn>
				...
				<TR style="HEIGHT: 28px">
					<TD style="WIDTH: 101.88%; HEIGHT: 27px" background="../../Style/Images/treetopbg.jpg"
						...
						&nbsp;&nbsp; <FONT face="宋体">
							...
							<asp:button style="Z-INDEX: 0" id="Button1" runat="server" Text="查询重复管理编号" CssClass="ButtonFlat"></asp:button></FONT></TD>
				</TR>
				<tr>
				...
				<tr>
					...
					<td style="Z-INDEX: 0; WIDTH: 78px" align="center">起始数量</td>
