<%@ Page language="c#" Codebehind="SmallFixedAssetsForDept.aspx.cs" AutoEventWireup="false" Inherits="HDSZCheckFlow.UI.Asset.SmallAssets.SmallFixedAssetsForDept"  EnableEventValidation="false" %>
    ...
    <td colSpan=6 align=center><FONT face=宋体 
      ...
      >
        <TR>
          ...
          <TD style="TEXT-ALIGN: center; WIDTH: 82px; HEIGHT: 23px" 
            > 责任人工号</TD>
          <TD style="WIDTH: 182px; HEIGHT: 23px"><asp:textbox id=txtKeeperCode runat="server" Width="128px" style="Z-INDEX: 0"></asp:textbox></TD>
        ...
        <TR>
          ...
          <TD style="WIDTH: 182px" align=right><asp:button style="Z-INDEX: 0" id=btnQuery runat="server" Width="72px" Text="查询" CssClass="redButtonCss"></asp:button></TD>
          <TD colSpan=2 align=center><asp:button style="Z-INDEX: 0" id="btnExportExcel" runat="server" Width="72px" Text="导出Excel" CssClass="redButtonCss"></asp:button></TD></TR></TABLE></FONT></td></tr>
  <TR style="HEIGHT: 28px">
