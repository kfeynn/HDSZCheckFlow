<%@ Page language="c#" Codebehind="AssetApplySheetStateInfo.aspx.cs" AutoEventWireup="false" Inherits="HDSZCheckFlow.UI.Asset.CheckFlow.AssetApplySheetStateInfo"  EnableEventValidation="false" %>
...
<HTML>
	...
	.cssFooter { TEXT-ALIGN: right; COLOR: blue }
		</style>
	</HEAD>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table class="GbText" id="tabDispDocument" style="Z-INDEX: 101; POSITION: absolute; BORDER-BOTTOM-COLOR: #0066cc; BORDER-TOP-COLOR: #0066cc; WIDTH: 100%; BORDER-COLLAPSE: collapse; HEIGHT: 36px; BORDER-RIGHT-COLOR: #0066cc; BORDER-LEFT-COLOR: #0066cc; TOP: 0px; LEFT: 0px"
				...
				<tr id="postail" style="DISPLAY: block; HEIGHT: 28px">
					<td style="BACKGROUND-COLOR: #e8f4ff; WIDTH: 20%; HEIGHT: 29px" align="center" colSpan="6"><FONT face="宋体">
							<div>
							</div>
						</FONT>
					</td>
			...
			<asp:linkbutton id="linkToPage" style="Z-INDEX: 102; POSITION: absolute; TOP: 512px; LEFT: 400px"
				runat="server"></asp:linkbutton><INPUT id="HerdSort" style="Z-INDEX: 103; POSITION: absolute; TOP: 424px; LEFT: 200px"
