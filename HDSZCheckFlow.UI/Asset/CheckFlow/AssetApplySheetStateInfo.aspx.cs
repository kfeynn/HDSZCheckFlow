...
namespace HDSZCheckFlow.UI.Asset.CheckFlow
{
	...
	public class AssetApplySheetStateInfo : System.Web.UI.Page
	{
		...
		private void bindSearchResult()
		{
			...
			AdvancedSearchGo("v_Asset_ApplySheetStateInfo","编号",out oPageViewState.PCount,20,oPageViewState.PIndex,/*oPageViewState.SSort*/"编号",1/*oPageViewState.SortType*/,SQuery,sFields);
			//脚标
		...
		private void btnOutput_Click(object sender, System.EventArgs e)
		{
			...
			string cmdStr = "select * from v_Asset_ApplySheetStateInfo order by 编号 asc";
