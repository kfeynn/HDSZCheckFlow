<%@ Page language="c#" Codebehind="PriceCheckApplyList.aspx.cs" AutoEventWireup="false" Inherits="HDSZCheckFlow.UI.Asset.PriceCheck.PriceCheckApplyList"  EnableEventValidation="false" %>
					...
					<td align="center" colspan="6"><FONT face="宋体">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD style="HEIGHT: 17px">
										<asp:TextBox id="txtApplyNo" runat="server" style="Z-INDEX: 0"></asp:TextBox></TD>
									<TD align="center" style="Z-INDEX: 0; HEIGHT: 17px">起始日期</TD>
									<TD style="HEIGHT: 17px">
										<asp:TextBox id="txtDateFrom" runat="server" onfocus="WdatePicker({skin:'whyGreen',maxDate:'#F{$dp.$D(\'txtDateTo\')||\'2020-10-01\'}'})"
											Width="90px" style="Z-INDEX: 0"></asp:TextBox></TD>
								...
								<TR>
									...
									<TD>合 同 号</TD>
									<TD>
										<asp:TextBox style="Z-INDEX: 0" id="txtBargan" runat="server"></asp:TextBox>
									</TD>
