					...
					<td align="center" colSpan="6"><FONT face="宋体">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD style="WIDTH: 433px; HEIGHT: 17px"><asp:textbox id="txtApplyNo" runat="server" Width="336px"></asp:textbox>(以逗号分隔)</TD>
									<TD style="WIDTH: 106px; HEIGHT: 17px" align="right">是否以标注付款：</TD>
								...
								<TR>
									...
									<TD style="WIDTH: 433px"><asp:textbox id="txtProduct" runat="server" Width="336px"></asp:textbox>(以逗号分隔)</TD>
									<TD align="right" style="WIDTH: 106px">
										<asp:CheckBox id="CheckBox2" Text="是否以入库" runat="server"></asp:CheckBox>
									</TD>
									<TD>
										<asp:RadioButton id="rbtIsInStoreYes" runat="server" Text="是" GroupName="rbtIsInStore"></asp:RadioButton>
										<asp:RadioButton id="rbtIsInStoreNo" runat="server" Text="否" GroupName="rbtIsInStore"></asp:RadioButton>
						...
						<div id="DIV1" style="BORDER-RIGHT: 0px; PADDING-RIGHT: 0px; BORDER-TOP: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 0px; OVERFLOW: auto; BORDER-LEFT: 0px; WIDTH: 900px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px; HEIGHT: 200px">
							<asp:datagrid id="dgApply" runat="server" Width="100%" AutoGenerateColumns="False" BackColor="White"
								...
								<Columns>
									...
									<asp:TemplateColumn ItemStyle-Width="50px" HeaderText="付款">
										<ItemTemplate>
											<asp:Label id = "lblyfk" Runat = "server" Text = '<%# int.Parse(DataBinder.Eval( Container.DataItem,"IsPayFor").ToString()) == 1 ? "是" : "否" %>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									...
									<asp:BoundColumn DataField="Id" HeaderText="裁决金额"></asp:BoundColumn>
									<asp:BoundColumn DataField="ApplySheetHead_Pk" HeaderText="申请人"></asp:BoundColumn>
									<asp:BoundColumn DataField="PayForSigner" HeaderText="标注人员" ItemStyle-Width="100px"></asp:BoundColumn>
									<asp:BoundColumn DataField="ReallyPayMoney" HeaderText="金额" ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
									<asp:BoundColumn DataField="PayForDatetime" HeaderText="付款时间" DataFormatString="{0:yyyy-MM-dd}" ItemStyle-Width="100px"></asp:BoundColumn>
									<asp:BoundColumn DataField="PayForRemark" HeaderText="付款备注" ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
				...
				<tr id="postail" style="DISPLAY: block; HEIGHT: 28px">
					<td style="WIDTH: 20%; BACKGROUND-COLOR: #e8f4ff" align="center" colSpan="6"><FONT face="宋体"><asp:panel id="Panel1" runat="server" BackColor="White" Visible="False">
								<TABLE id="Table2" borderColor="#003333" cellSpacing="0" cellPadding="0" width="100%" border="1">
									<TBODY>
										<TR>
											<TD style="WIDTH: 101px; HEIGHT: 2px" align="right">是否付款 ：</TD>
											<TD style="HEIGHT: 2px">&nbsp;
												<asp:CheckBox id="CheckBox3" runat="server" Text="付款"></asp:CheckBox>
											<TD style="HEIGHT: 2px"></TD>
										</TR>
										<TR>
											<TD style="WIDTH: 101px; HEIGHT: 2px" align="right">预付金额：</TD>
											<TD style="HEIGHT: 2px">&nbsp;
												<asp:TextBox id="TextBox1" runat="server" Width="136px"></asp:TextBox>（默认为裁决金额）
											</TD>
					</td>
					<TD style="HEIGHT: 2px"></TD>
				</tr>
				<TR>
					<TD style="WIDTH: 101px" align="right">付款备注：</TD>
					<TD>&nbsp;
