		...
		<form id="Form1" method="post" runat="server">
			...
			<table class="GbText" id="tabDispDocument" style="Z-INDEX: 101; BORDER-LEFT-COLOR: #0066cc; LEFT: 0px; BORDER-BOTTOM-COLOR: #0066cc; WIDTH: 100%; BORDER-TOP-COLOR: #0066cc; POSITION: absolute; TOP: 0px; BORDER-COLLAPSE: collapse; HEIGHT: 36px; BORDER-RIGHT-COLOR: #0066cc"
					...
					<td align="center" colSpan="6"><FONT face="宋体">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD style="WIDTH: 435px; HEIGHT: 17px"><asp:textbox id="txtApplyNo" runat="server" Width="336px"></asp:textbox>(以逗号分隔)</TD>
									<TD style="WIDTH: 117px; HEIGHT: 17px" align="right">是否以标注预付款：</TD>
								...
								<TR>
									...
									<TD style="WIDTH: 435px"><asp:textbox id="txtProduct" runat="server" Width="336px"></asp:textbox>(以逗号分隔)</TD>
						...
						<div id="DIV1" style="BORDER-RIGHT: 0px; PADDING-RIGHT: 0px; BORDER-TOP: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 0px; OVERFLOW: auto; BORDER-LEFT: 0px; WIDTH: 900px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px; HEIGHT: 154px"><asp:datagrid id="dgApply" runat="server" Width="100%" DataKeyField="Id" AllowSorting="True" BorderColor="#93BEE2"
								...
								<Columns>
									...
									<asp:TemplateColumn ItemStyle-Width="50px">
										<ItemTemplate>
											<asp:Button id="btnMark" runat="server" Text="标 注" CssClass="ButtonFlat" CommandName="ReMark" CommandArgument='<%# DataBinder.Eval( Container.DataItem,"Id") %>'>
											</asp:Button>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn ItemStyle-Width="50px" HeaderText="预付款">
										<ItemTemplate>
											<asp:Label id = "lblyfk" Runat = "server" Text = '<%# int.Parse(DataBinder.Eval( Container.DataItem,"Earnest").ToString()) == 1 ? "是" : "否" %>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									...
									<asp:BoundColumn DataField="EarnestSigner" HeaderText="标注人员" ItemStyle-Width="100px"></asp:BoundColumn>
									<asp:BoundColumn DataField="EarnestDatetime" HeaderText="时间" DataFormatString="{0:yyyy-MM-dd}" ItemStyle-Width="100px"></asp:BoundColumn>
									<asp:BoundColumn DataField="EarnestRemark" HeaderText="备注" ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
				...
				<tr style="HEIGHT: 28px">
					<td style="WIDTH: 100%; HEIGHT: 31px" align="right" background="../../Style/Images/treetopbg.jpg"
						colSpan="6"><FONT face="宋体"></FONT><FONT face="宋体"></FONT><FONT face="宋体"><asp:checkbox id="chbSelectAll" runat="server" Text="全选" AutoPostBack="True"></asp:checkbox>&nbsp;&nbsp;&nbsp;
							<asp:button id="btnUpdateShuju" runat="server" Width="56px" Text="更 新" CssClass="ButtonFlat"
				...
				<tr id="postail" style="HEIGHT: 28px">
					<td style="WIDTH: 20%; BACKGROUND-COLOR: #e8f4ff" align="center" colSpan="6"><FONT face="宋体"><asp:panel id="Panel1" runat="server" BackColor="White" Visible="False">
								<TABLE id="Table2" borderColor="#009999" cellSpacing="0" cellPadding="0" width="100%" border="1">
									<TBODY>
										<TR>
											<TD style="WIDTH: 101px; HEIGHT: 2px" align="right">是否预付款：</TD>
											<TD style="HEIGHT: 2px">&nbsp;
												<asp:checkbox id="Checkbox2" runat="server" Text="预付款"></asp:checkbox>
											<TD style="HEIGHT: 2px"></TD>
										</TR>
										<TR>
											<TD style="WIDTH: 101px; HEIGHT: 2px" align="right">预付款标注人员：</TD>
											<TD style="HEIGHT: 2px">&nbsp;
												<asp:textbox id="TextBox1" runat="server" Width="136px" Enabled="False"></asp:textbox></TD>
											<TD style="HEIGHT: 2px"></TD>
										</TR>
										<TR>
											<TD style="WIDTH: 101px; HEIGHT: 2px" align="right">标注时间：</TD>
											<TD style="HEIGHT: 2px">&nbsp;
										...
										<TR>
											<TD style="WIDTH: 101px" align="right">预付款备注：</TD>
											<TD>&nbsp;
				...
				<TR>
					...
					<TD>&nbsp;
						<asp:button id="btnEnter" runat="server" Width="83px" Text="确定" CssClass="ButtonFlat"></asp:button><asp:label id="lblMessage" runat="server"></asp:label></TD>
					<TD></TD>
				</TR>
			</table>
