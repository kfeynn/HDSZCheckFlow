					...
					<td align="center" colSpan="6"><FONT face="宋体">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD style="WIDTH: 432px; HEIGHT: 17px"><asp:textbox id="txtApplyNo" runat="server" Width="336px"></asp:textbox>(以逗号分隔)</TD>
									<TD style="WIDTH: 92px; HEIGHT: 17px" align="right">是否以标注入库</TD>
								...
								<TR>
									...
									<TD style="WIDTH: 432px"><asp:textbox id="txtProduct" runat="server" Width="336px"></asp:textbox>(以逗号分隔)</TD>
									<TD align="right" style="WIDTH: 92px"><asp:checkbox id="CheckBox2" runat="server" Text="是否验收"></asp:checkbox></TD>
									<TD><asp:radiobutton id="rbtChiceYes" runat="server" Text="是" GroupName="rbtChice"></asp:radiobutton><asp:radiobutton id="rbtChiceNo" GroupName="rbtChice" runat="server" Text="否"></asp:radiobutton>
				...
				<tr id="bodyInfo" style="DISPLAY: block; HEIGHT: 22px">
					<td style="WIDTH: 600px; HEIGHT: 190px; BACKGROUND-COLOR: #e8f4ff" align="left" colSpan="6">
						<div id="DIV2" style="BORDER-RIGHT: 0px; PADDING-RIGHT: 0px; BORDER-TOP: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 0px; OVERFLOW: auto; BORDER-LEFT: 0px; WIDTH: 100%; PADDING-TOP: 0px; BORDER-BOTTOM: 0px; HEIGHT: 25px"
							...
							<asp:button id="btnPageShi" runat="server" Width="70px" Text="退 十 页 " CssClass="ButtonFlat"></asp:button>&nbsp;&nbsp;
							<asp:button id="btnShang" runat="server" Width="40px" Text="上页" CssClass="ButtonFlat"></asp:button>&nbsp;&nbsp;
							<asp:button id="btnXia" runat="server" Width="40px" Text="下页" CssClass="ButtonFlat"></asp:button>&nbsp;&nbsp;
							<asp:button id="btnTuiShi" runat="server" Width="70px" Text="前 十 页" CssClass="ButtonFlat"></asp:button>&nbsp;&nbsp;
						...
						<div id="DIV1" style="BORDER-RIGHT: 0px; PADDING-RIGHT: 0px; BORDER-TOP: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 0px; OVERFLOW: auto; BORDER-LEFT: 0px; WIDTH: 900px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px; HEIGHT: 200px"><asp:datagrid id="dgApply" runat="server" Width="100%" AutoGenerateColumns="False" BackColor="White"
								...
								<Columns>
									...
									<asp:TemplateColumn ItemStyle-Width="50px" HeaderText="入库">
										<ItemTemplate>
											<asp:Label id = "lblyfk" Runat = "server" Text = '<%# int.Parse(DataBinder.Eval( Container.DataItem,"IsInStore").ToString()) == 1 ? "是" : "否" %>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									...
									<asp:BoundColumn DataField="InStoreSigner" HeaderText="入库标注人员" ItemStyle-Width="100px"></asp:BoundColumn>
									<asp:BoundColumn DataField="InStoreDatetime" HeaderText="入库时间" DataFormatString="{0:yyyy-MM-dd}"
				...
				<tr id="postail" style="DISPLAY: block; HEIGHT: 28px">
					<td style="WIDTH: 20%; BACKGROUND-COLOR: #e8f4ff" align="center" colSpan="6"><FONT face="宋体"><asp:panel id="Panel1" runat="server" BackColor="White" Visible="False">
								<TABLE id="Table2" borderColor="#003333" cellSpacing="0" cellPadding="0" width="100%" border="1">
									<TR>
										<TD style="WIDTH: 101px; HEIGHT: 2px" align="right">是否 ：</TD>
										<TD style="HEIGHT: 2px">&nbsp;
											<asp:CheckBox id="CheckBox3" runat="server" Text="入库"></asp:CheckBox>
										<TD style="HEIGHT: 2px"></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 101px; HEIGHT: 2px" align="right">入库标注人员：</TD>
										<TD style="HEIGHT: 2px">&nbsp;
											<asp:TextBox id="TextBox1" runat="server" Width="136px" Enabled="False"></asp:TextBox></TD>
										<TD style="HEIGHT: 2px"></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 101px; HEIGHT: 2px" align="right">入库时间：</TD>
										<TD style="HEIGHT: 2px">&nbsp;
